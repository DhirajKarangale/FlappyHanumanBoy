...
public class BGCollector : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        foreach(GameObject background in backgrounds){
            ...
            //  uncomment the line below in prodution and comment the one below it
              background.GetComponent<SpriteRenderer>().sprite = worldBgSprite[GameController.instance.GetSelectedWorld()];
          //  background.GetComponent<SpriteRenderer>().sprite = worldBgSprite[1];
